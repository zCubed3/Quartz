...
=================
*/
void debris_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage)
{
	G_FreeEdict (self);
}
...
*/
void func_explosive_explode (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage)
{
	vec3_t	origin;
	vec3_t	chunkorigin;
	vec3_t	size;
...
{
	func_explosive_explode (self, self, other, self->health);
}
...
void barrel_delay (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage)
{
	self->takedamage = DAMAGE_NO;
	self->nextthink = level.time + 2 * FRAMETIME;
...
*/
void misc_deadsoldier_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage)
{
	int		n;
