...
void button_killed (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage)
{
...
void door_killed (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage)
{
	edict_t	*ent;
...
void door_secret_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage)
{
	self->takedamage = DAMAGE_NO;
