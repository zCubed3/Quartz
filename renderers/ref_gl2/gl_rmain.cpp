...
qboolean R_SetMode (void)
{
	...
	if ( ( err = (rserr_t)GLimp_SetMode( &vid.width, &vid.height, gl_mode->value, fullscreen ) ) == rserr_ok )
	{
...
{	
	...
	ri.Con_Printf (PRINT_ALL, "ref_gl2 version: %s\n", REF_VERSION);
	...
	*/
	...
	// TODO: zCubed: Same issue as before, Quake doesn't like HUGE logs, and modern OpenGL drivers have SO MANY extensions!
	...
	*/
		 ...
		 strstr( gl_config.extensions_string, "GL_SGI_compiled_vertex_array" ) )
	{
		...
		glLockArraysEXT = ( void * ) qwglGetProcAddress( "glLockArraysEXT" );
		glUnlockArraysEXT = ( void * ) qwglGetProcAddress( "glUnlockArraysEXT" );
	}
	else
	{
	...
	if ( strstr( gl_config.extensions_string, "GL_ARB_multitexture" ) )
	{
		if ( gl_ext_multitexture->value )
		{
			...
			glMultiTexCoord2f = ( void * ) qwglGetProcAddress( "glMultiTexCoord2fARB" );
			glActiveTextureARB = ( void * ) qwglGetProcAddress( "glActiveTextureARB" );
			glClientActiveTextureARB = ( void * ) qwglGetProcAddress( "glClientActiveTextureARB" );
	...
	if ( strstr( gl_config.extensions_string, "GL_SGIS_multitexture" ) )
	{
		...
		else if ( gl_ext_multitexture->value )
		{
			...
			glMultiTexCoord2f = ( void * ) qwglGetProcAddress( "glMultiTexCoord2f" );
			glSelectTextureSGIS = ( void * ) qwglGetProcAddress( "glSelectTextureSGIS" );
